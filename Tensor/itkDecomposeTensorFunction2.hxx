...
DecomposeTensorFunction2<TInput, TRealType, TOutput>::DecomposeTensorFunction2() = default;

template <typename TInput, typename TRealType, typename TOutput>
void
DecomposeTensorFunction2<TInput, TRealType, TOutput>::EvaluateEigenDecomposition(InputMatrixType &  M,
                                                                                 OutputMatrixType & D,
                                                                                 OutputMatrixType & V)
{
...
template <typename TInput, typename TRealType, typename TOutput>
void
DecomposeTensorFunction2<TInput, TRealType, TOutput>::EvaluateSymmetricEigenDecomposition(InputMatrixType &  M,
                                                                                          OutputMatrixType & D,
                                                                                          OutputMatrixType & V)
{
...
template <typename TInput, typename TRealType, typename TOutput>
void
DecomposeTensorFunction2<TInput, TRealType, TOutput>::EvaluateRightPolarDecomposition(InputMatrixType &  M,
                                                                                      OutputMatrixType & R,
                                                                                      OutputMatrixType & S)
{
  OutputMatrixType U;
...
template <typename TInput, typename TRealType, typename TOutput>
void
DecomposeTensorFunction2<TInput, TRealType, TOutput>::EvaluateLeftPolarDecomposition(InputMatrixType &  M,
                                                                                     OutputMatrixType & S,
                                                                                     OutputMatrixType & R)
{
  OutputMatrixType U;
...
template <typename TInput, typename TRealType, typename TOutput>
void
DecomposeTensorFunction2<TInput, TRealType, TOutput>::EvaluateQRDecomposition(InputMatrixType &  M,
                                                                              OutputMatrixType & Q,
                                                                              OutputMatrixType & R)
{
  unsigned int RowDimensions = M.Rows();
...
template <typename TInput, typename TRealType, typename TOutput>
void
DecomposeTensorFunction2<TInput, TRealType, TOutput>::EvaluateSVDDecomposition(InputMatrixType &  M,
                                                                               OutputMatrixType & U,
                                                                               OutputMatrixType & W,
                                                                               OutputMatrixType & V)
{
...
template <typename TInput, typename TRealType, typename TOutput>
void
DecomposeTensorFunction2<TInput, TRealType, TOutput>::EvaluateSVDEconomyDecomposition(InputMatrixType &  M,
                                                                                      OutputMatrixType & W,
                                                                                      OutputMatrixType & V)
{
  /**
...
template <typename TInput, typename TRealType, typename TOutput>
void
DecomposeTensorFunction2<TInput, TRealType, TOutput>::EvaluateCholeskyDecomposition(InputMatrixType &  M,
                                                                                    OutputMatrixType & L)
{
...
DecomposeTensorFunction2<TInput, TRealType, TOutput>::EvaluateDeterminant(InputMatrixType & M)
{
...
template <typename TInput, typename TRealType, typename TOutput>
void
DecomposeTensorFunction2<TInput, TRealType, TOutput>::PrintSelf(std::ostream & /* os */, Indent /* indent */) const
{}
} // end namespace itk
